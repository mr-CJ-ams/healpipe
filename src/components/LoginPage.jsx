...
import { ArrowDown, ArrowRight, CheckCircle2, Chrome, CircleAlert, Database, GitBranch, LoaderCircle, RotateCcw, ShieldCheck, Waypoints } from 'lucide-react'
  ...
  return (
    <main className="auth-page flex min-h-screen items-center justify-center bg-[#091312] px-5 py-12 text-slate-100">
      <section className="panel auth-card w-full max-w-md p-8 text-center sm:p-10" id="auth-panel">
        ...
        <button className="auth-back-link" onClick={() => setShowAuth(false)}><ArrowDown size={14} className="rotate-90" />Back to overview</button>
